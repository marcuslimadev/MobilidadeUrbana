        ...
        <div class="dashboard-quick-link header-dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <div class="quick-link-list">
                    ...
                    <x-permission_check permission="view driver withdrawals">
                        <a href="{{ route('admin.deposit.pending') }}" class="quick-link-item">
                            <span class="quick-link-item__icon">
                    ...
                    <x-permission_check permission="view user tickets">
                    ...
                    <x-permission_check permission="general settings">
                    ...
                    <x-permission_check permission="system configuration">
                    ...
                    <x-permission_check permission="notification settings">
                                        ...
                                        <div class="notification__list-thumb">
                                            @if ($notification->user)
                                                @if ($notification->user->image)
                                                    <img class="fit-image"
                                                        src="{{ @$notification->user->image_src }}">
                                                @else
